...
def check_mcafee():
    ...
    return [x for x in x + y + z if "McAfee" in x] != []
...
def check_office():
    ...
    return [x for x in x + y + z if "Microsoft Office Professional Plus 2016 - en-us" in x] != []
...
def check_security_groups():
    ...
    '''
    try:
        print(win32net.NetGroupGetUsers(None, 'Пользователи', 0))
